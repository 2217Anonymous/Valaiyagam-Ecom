...
Read-optimized dashboards, KPIs, exports, and scheduled reports.

## Data ownership

Reporting projections, export jobs, and materialized read models only.

## Events

Consumes business events from all source domains.

## Extraction source

Implement from app/modules/reporting without writing operational domain tables.
