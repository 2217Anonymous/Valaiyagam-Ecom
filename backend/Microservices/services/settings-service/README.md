...
Store profile, tax rules, shipping zones, COD policy, and feature flags.
...
Publishes settings.changed and feature_flag.changed.

## Extraction source

Implement from app/modules/settings; secrets remain in a secrets manager.
