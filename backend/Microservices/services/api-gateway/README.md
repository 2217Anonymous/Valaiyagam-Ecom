...
Single public entry point, routing, JWT verification, rate limiting, and correlation IDs.

## Data ownership

No business data; route and security policy configuration only.

## Events

None. It forwards HTTP requests and propagates trace context.

## Extraction source

New platform component; it is not copied from a business module.
